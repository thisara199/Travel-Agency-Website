    ...
    <div className='py-12 bg-gray-100'>
      <div className='container px-4 mx-auto'>
        ...
        <div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
          {Clients.map((client) => (
            <div key={client.name} className='flex flex-col items-center p-8 transition duration-300 transform bg-white rounded-lg shadow-md cursor-pointer hover:scale-110'>
              <div className='flex justify-center py-6 mb-4'>
                <img src={client.image} alt={client.name} className='w-20 h-20 rounded-full' />
              </div>
