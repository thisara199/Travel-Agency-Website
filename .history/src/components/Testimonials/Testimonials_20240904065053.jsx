      ...
      <div className='container px-4 mx-auto'>
        ...
        <div className='grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 '>
          {Clients.map((client) => (
            <div
            data-aos="fade-up"
            data-aos-delay={Clients.aosDelay}
            key={client.name} className='flex flex-col items-center p-8 transition duration-300 transform bg-white rounded-lg shadow-md cursor-pointer hover:scale-110'>
