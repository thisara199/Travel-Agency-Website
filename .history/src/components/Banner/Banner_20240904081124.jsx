        ...
        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2">
          <div className='mt-0 lg:mt-24'>
           ...
           <div className='flex flex-col justify-center gap-6 mt-0 sm:pt-0 lg:mt-10'>
            <h1 data-aos="fade-up" className='mb-0 text-3xl font-bold sm:text-4xl lg:mb-10'>Book your dream vacation with us today and get 20% off your entire package. Experience the best of Sri Lanka with our tailored travel experiences. Hurry, this offer is valid until the end of the month!</h1>
