      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2">
          <div>
            ...
            <h2 className='text-xl font-semibold'>Trincomalee: Dive Into Serenity</h2>
            ...
            <h2 className='text-xl font-semibold'>Dambulla: Ballooning Over History</h2>
            ...
            <h2 className='text-xl font-semibold'>Pasikudah: Dive Into Crystal Clear Waters</h2>
            ...
            <h2 className='text-xl font-semibold'>Kithulgala: Waterfall Wonderland</h2>
            ...
            <h2 className='text-xl font-semibold'>Arugam Bay: Surf’s Up</h2>
            ...
            <h2 className='text-xl font-semibold'>Bentota: Jet Ski Thrills</h2>
            ...
            <h2 className='text-xl font-semibold'>South Coast Diving: Explore the Depths</h2>
