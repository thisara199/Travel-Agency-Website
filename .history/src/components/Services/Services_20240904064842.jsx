  ...
  return (
    <div className='py-12 bg-gray-100'>
      <div className='container px-4 mx-auto'>
        ...
        <div data-aos="flip-left" className='grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 '>
          {services.map((service) => (
            <div  key={service.title} className='flex flex-col items-center p-8 transition duration-300 transform bg-white rounded-lg shadow-md cursor-pointer hover:scale-110'>
