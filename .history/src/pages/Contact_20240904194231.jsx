  ...
  return (
    <div className="py-12 bg-gray-100">
      <div className="container px-4 mx-auto">
        ...
        <p className="mb-12 text-center text-gray-600">We'd love to hear from you! Feel free to reach out with any inquiries or questions.</p>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg">
            ...
            <ul>
              <li className="mb-4">
                <strong>Phone:</strong> <a href="tel:+94-771234567" className="text-blue-600 hover:underline">+94 77 123 4567</a>
              </li>
              <li className="mb-4">
                <strong>Email:</strong> <a href="mailto:info@travelceylon.com" className="text-blue-600 hover:underline">info@travelceylon.com</a>
              </li>
              <li className="mb-4">
                <strong>Address:</strong> <p className="text-gray-600">123 Main Street, Colombo, Sri Lanka</p>
              </li>
            </ul>
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg">
            ...
            <form action="" className="space-y-6">
              <div>
                ...
                <input type="text" className="w-full p-2 border border-gray-300 rounded" placeholder="Enter your name" required />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea className="w-full p-2 border border-gray-300 rounded" rows="5" placeholder="Write your message" required></textarea>
              </div>
              <button type="submit" className="w-full py-3 text-white bg-blue-600 rounded hover:bg-blue-800">Send Message</button>
            </form>
          </div>
        </div>
      </div>
